...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    fetchPopularSchools();
    fetchPopularClubs();
    if(user && isInitialized) fetchRecommendedClubs();
    // setIsLoading(false);
  }, [user, isInitialized]);
  ...
  return (
    ...
    <section className="container mx-auto px-4 mb-16 md:mb-24">
      <div className="mx-auto">
        <div className="mb-20">
          ...
          <div className="flex items-start gap-4 overflow-x-auto pb-4 scrollbar-hide cursor-pointer">
            {popularSchools.map((school, index) => {
              return (
                <div key={index} className="bg-white rounded-xl shadow-lg border border-blue-100 flex-shrink-0 w-80" onClick={() => router.push(`/school/${school.id}`)}>
                  <div className="w-full h-50 bg-blue-100 flex items-center justify-center mb-4 mx-auto">
                    <img
                  ...
                  <div className="flex items-center justify-center gap-1 text-gray-600 pb-2">
                    <Building className="w-4 h-4" />
                    <span>{school.clubsCount} Clubs</span>
                  </div>
                  <div className="flex items-center justify-center gap-1 text-gray-600 mb-4 pb-2">
        ...
        <div className="mb-20">
          ...
          <div className="flex items-start gap-4 overflow-x-auto pb-4 scrollbar-hide cursor-pointer">
            {popularClubs.map((club, index) => {
              return (
                <div key={index} className="bg-white rounded-xl shadow-lg border border-blue-100 flex-shrink-0 w-80">
                  <div className="w-full h-50 bg-blue-100 flex items-center justify-center mb-4 mx-auto">
                    <img
                      src="https://www.texastech.edu/universities/ttu-campus-2022.jpg"
                      className="w-full h-full text-blue-600 rounded-lg"
                  ...
                  <p className="text-gray-600 text-center mb-4 pb-2">{club.reviewCount}{club.reviewCount === 1 ? " Review" : " Reviews"}</p>
                </div>
              )
            })}
          </div>
        ...
        {user && 
          <div>
            <p className="text-xl md:text-2xl text-gray-900 mb-6 max-w-2xl">Recommended for you</p>
            <div className="flex items-start gap-4 overflow-x-auto pb-4 scrollbar-hide cursor-pointer">
                ...
                return (
                  <div key={index} className="bg-white rounded-xl shadow-lg border border-blue-100 flex-shrink-0 w-80">
                    ...
                    <div className="h-15 flex flex-col items-center justify-center mb-2 px-4">
                      ...
                      <p className="text-gray-600 text-center mb-4 pb-2">{club.reviewCount} Reviews</p>
                  </div>
                )
              })}
            </div>
