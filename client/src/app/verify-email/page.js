    ...
    case "error":
      return (
        <div className="text-center">
          ...
          <div className="space-y-3">
            <Button
              className="w-full bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 text-white py-3 rounded-xl font-semibold"
            ...
            <Button
              variant="outline"
              className="w-full border-2 border-gray-200 dark:border-zinc-700 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-zinc-800 py-3 rounded-xl font-semibold bg-transparent"
              asChild
            >
